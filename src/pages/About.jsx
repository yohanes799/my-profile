  ...
  const skills = [
    {
      name: 'Frontend',
      icon: <FaCode />,
      desc: 'React, Tailwind CSS, JavaScript',
      color: 'text-blue-400',
    },
    {
      name: 'UI/UX',
      icon: <FaPaintBrush />,
      desc: 'Figma(Basic to Intermediate), Responsive Design',
      color: 'text-purple-400',
    },
    {
      name: 'Backend',
      icon: <FaServer />,
      desc: 'Node.js, Express (Basic), laravel(Basic)',
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center mb-20">
        <div className="flex-1">
          ...
          <p className="text-slate-400 leading-relaxed mb-4">
            Saya adalah seorang pelajar/mahasiswa yang saat ini sedang menjalani
            program magang. Saya memiliki passion yang besar di bidang
            teknologi, khususnya dalam pengembangan website.
          </p>
          <p className="text-slate-400 leading-relaxed">
            Fokus utama saya adalah menciptakan pengalaman digital yang menarik
            dan fungsional. Melalui magang ini, saya berharap dapat mengasah
            keterampilan saya, belajar dari para profesional, dan berkontribusi
            pada proyek-proyek yang nyata.
          </p>
        </div>
